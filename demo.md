...
**Demo Reference URLs:**
*   **Left Side (Bank API):** [http://localhost:3004/investor-status?credential=investor42](http://localhost:3004/investor-status?credential=investor42)
*   **Right Side (Bridge API):** [http://localhost:3007/](http://localhost:3007/)
